...
$sql = "SELECT CLIENT_ID, CLIENT_NAME, PHONE FROM client WHERE CLIENT_NAME LIKE ? AND DEPT_NO = 1 AND USER_ID = $user_id ORDER BY CLIENT_ID DESC LIMIT 20";
...
while ($row = $result->fetch_assoc()) {
    ...
    <div class="clients-data-container">
        ...
        <div class="clients-data" data-id="clients-data<?= htmlspecialchars($row["CLIENT_ID"]); ?>"
            ...
            data-client-phone="<?= htmlspecialchars($row["PHONE"]); ?>">
