...
include 'dbconn.php';
    ...
    $resualt_sum_ammount_new_for = $conn->query("SELECT SUM(AMMOUNT) as total_for FROM TRANSACTION WHERE CURRENCY ='new' and CLIENT_ID= " . $client_id . " and FOR_OR_ON ='عليه'");
    $resualt_sum_ammount_old_for = $conn->query("SELECT SUM(AMMOUNT) as total_for FROM TRANSACTION WHERE CURRENCY ='old' and CLIENT_ID= " . $client_id . " and FOR_OR_ON ='عليه'");
    $resualt_sum_ammount_sa_for = $conn->query("SELECT SUM(AMMOUNT) as total_for FROM TRANSACTION WHERE CURRENCY ='sa' and CLIENT_ID= " . $client_id . " and FOR_OR_ON ='عليه'");
    ...
    $resualt_sum_ammount_new_on = $conn->query("SELECT SUM(AMMOUNT) as total_on FROM TRANSACTION WHERE CURRENCY ='new' and CLIENT_ID= " . $client_id . " and FOR_OR_ON ='له'");
    $resualt_sum_ammount_old_on = $conn->query("SELECT SUM(AMMOUNT) as total_on FROM TRANSACTION WHERE CURRENCY ='old' and CLIENT_ID= " . $client_id . " and FOR_OR_ON ='له'");
    $resualt_sum_ammount_sa_on = $conn->query("SELECT SUM(AMMOUNT) as total_on FROM TRANSACTION WHERE CURRENCY ='sa' and CLIENT_ID= " . $client_id . " and FOR_OR_ON ='له'");
