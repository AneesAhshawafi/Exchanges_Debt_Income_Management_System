...
function calc_total_ammounts($client_id) {
    ...
    $resualt_sum_ammounts = $conn->query("SELECT sum_ammount_new,sum_ammount_old,sum_ammount_sa FROM debt WHERE CLIENT_ID = " . $client_id . " ORDER BY DEBT_ID DESC LIMIT 1");
